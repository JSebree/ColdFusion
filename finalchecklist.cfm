...
<cfdirectory directory="#expandpath('/')#followalong/mywebsite/" name="base" recurse="no">
<cfdirectory directory="#expandpath('/')#followalong/mywebsite/management/" name="manage" recurse="no">
...
<body>
	<h1>
    	Spring 2016 Website Database Implementation Info-2480 - 061 Final Project Checklist
    </h1>
	<div class="col-lg-3">
        ...
        <p>
        	All Projects are due on November 5th at 11:59pm.
        </p>
    </div>
    <div class="col-lg-9">
    	<h2>Public Area</h2>
